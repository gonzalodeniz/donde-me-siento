...
7. Validar conflictos y aforo antes de cerrar la distribución.
8. Guardar versiones para comparar alternativas.
...
**MVP**
Crear evento, configurar mesas, gestionar invitados, definir relaciones y restricciones, asignar a mesas (manual y drag & drop), detectar conflictos, guardar y cargar ficheros, autenticación básica.
